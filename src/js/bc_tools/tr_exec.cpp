          ...
          int seqId)
{
    ...
    auto v = b.db->getValuesNoCreate(b.db);
     ...
     int seqId)
{
    ...
    auto n = b.db->addNode(name, t.roll,b.db);
    ...
    int seqId)
{
    ...
    CONTRACT_id cn;
    cn.container=name;
    auto nn = b.db->getContract(cn,b.db);
    if (nn.valid())
    ...
    auto n = b.db->addContract(cn, t.roll,b.db);
     ...
     int seqId)
{
    ...
    auto n = b.db->getContract(cn,b.db);
    if (!n.valid())
