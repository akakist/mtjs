#ifndef __________broadcasterTreeService_EventInfo__HH
#define __________broadcasterTreeService_EventInfo__HH
...
#include "Events/System/Net/httpEvent.h"
#include "Event/bcEvent.h"
inline std::set<EVENT_id> getEvents_broadcasterTreeService()
{
